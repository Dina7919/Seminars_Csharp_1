// Console.WriteLine("GB Lesosn");
// int num = 5;
// int num2 = Convert.ToInt32(Console.ReadLine());
// Console.WriteLine(num + " " + num2);

// Задача1. Найдите квадрат
...
// Задача2. Напишите программу, которая на вход принимает два числа и проверяет, является ли первое число квадратом
...
// Задача3. Напишите программу, которая на вход принимает одно число (N), а на выходе показывает все целые числа в промежутке от -N до N
